...
matlabFunction(wse,'File','w_reg_dkcs.m')
matlabFunction(vse,'File','v_reg_dkcs.m')
...
matlabFunction(simplify(cut_point3(1,1),'IgnoreAnalyticConstraints',true,'Steps',steps),'File','cut_dkcs.m')
...
matlabFunction(simplify(weq_opt,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','w_b_dkcs.m')
matlabFunction(simplify(veq_opt,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','v_b_dkcs.m')
