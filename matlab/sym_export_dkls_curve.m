...
matlabFunction(wse,'File','w_reg_dklcs.m')
matlabFunction(vse,'File','v_reg_dklcs.m')
...
matlabFunction(simplify(cut_point3,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','cut_dklcs.m')
...
matlabFunction(simplify(weq_opt,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','w_b_dklcs.m')
matlabFunction(simplify(veq_opt,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','v_b_dklcs.m')
