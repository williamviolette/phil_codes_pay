...
wd1 = Aprime.*I1_s2 + ...  % full assets when within first cut point
      (-w_b(A,Aprime,alpha,p,r_high,r_low,Y_high).*p).*I1_s3 ; % water assets when greater than first cut point
...
wd2 = Aprime.*I2_s2 + (-w_b(A,Aprime,alpha,p,r_high,r_low,Y_low).*p).*I2_s3 ;
