...
[util1,util2,util3,util4,w1,w2,w3,w4] = ...
    u_w1loan(A,Aprime,alpha,p,r_high,r_low,r_lend,Y_high,Y_low,lambda_high,lambda_low);
...
for i = 1:n-1
    ...
    u_w1loan(Athis,Aprime,alpha,p,r_high,r_low,r_lend,Y_high,Y_low,lambda_high,lambda_low);
