...
if lambda_high==1 && lambda_low==1
        if nargout>4
            debt_12 = 1;
            [util1,w1] = u_ql(Lf_12,debt_12,alpha,p1f,p2f, Y_high + y_12f, lambda_high);
            [util2,w2] = u_ql(Lf_12,debt_12,alpha,p1f,p2f, Y_low  + y_12f, lambda_low);

            debt_34 = 0;
            [util3,w3] = u_ql(0,debt_34,alpha,p1f,p2f,Y_high + y_34f, lambda_high);
            [util4,w4] = u_ql(0,debt_34,alpha,p1f,p2f,Y_low  + y_34f, lambda_low);
        else
                debt_12 = 1;
                [util1] = u_ql(Lf_12,debt_12,alpha,p1f,p2f, Y_high + y_12f, lambda_high);
                [util2] = u_ql(Lf_12,debt_12,alpha,p1f,p2f, Y_low  + y_12f, lambda_low);

                debt_34 = 0;
                [util3] = u_ql(0,debt_34,alpha,p1f,p2f,Y_high + y_34f, lambda_high);
                [util4] = u_ql(0,debt_34,alpha,p1f,p2f,Y_low  + y_34f, lambda_low);
        end
else
         if nargout>4
            debt_12 = 1;
            [util1,w1] = u_ql(Lf_12,debt_12,alpha+lambda_high,p1f,p2f, Y_high + y_12f, 1);
            [util2,w2] = u_ql(Lf_12,debt_12,alpha+lambda_low,p1f,p2f, Y_low  + y_12f, 1);

            debt_34 = 0;
            [util3,w3] = u_ql(0,debt_34,alpha+lambda_high,p1f,p2f,Y_high + y_34f, 1);
            [util4,w4] = u_ql(0,debt_34,alpha+lambda_low,p1f,p2f,Y_low  + y_34f, 1);
        else
                debt_12 = 1;
                [util1] = u_ql(Lf_12,debt_12,alpha+lambda_high,p1f,p2f, Y_high + y_12f, 1);
                [util2] = u_ql(Lf_12,debt_12,alpha+lambda_low,p1f,p2f, Y_low  + y_12f, 1);

                debt_34 = 0;
                [util3] = u_ql(0,debt_34,alpha+lambda_high,p1f,p2f,Y_high + y_34f, 1);
                [util4] = u_ql(0,debt_34,alpha+lambda_low,p1f,p2f,Y_low  + y_34f, 1);
        end
