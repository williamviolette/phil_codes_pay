...
data_moments = [data_moments round( mean(data_moments,2),3)];
...
inc_t  =  4  ;  %%% which inc to estimate1
...
given=       [  r_lend    0      r_high      0        y_cv       0      .033    .034     y_avg(1)  p1(1)  p2(1)  200   n  3.2  r_slope(1) 0; ...
                ...
                r_lend    0      r_high      0        y_cv       0      .023    .04  mean(y_avg) mean(p1) mean(p2) 300 n  2.3 mean(r_slope) 0  ];
