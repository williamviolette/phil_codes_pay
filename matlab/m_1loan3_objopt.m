function [h,mom] = m_1loan3_objopt(a,given,data,option,option_moments,weights,prob,A,Aprime,Agrid,inA,minA,nA,chain)

given(option)=a; % put guess in given

est_mom = m_1loan3_obj(given,prob,A,Aprime,Agrid,inA,minA,nA,chain);
