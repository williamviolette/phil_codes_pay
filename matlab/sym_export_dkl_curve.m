...
matlabFunction(wse,'File','w_reg_dklc.m')
matlabFunction(vse,'File','v_reg_dklc.m')
...
matlabFunction(simplify(cut_point3,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','cut_dklc.m')
...
matlabFunction(simplify(weq_opt,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','w_b_dklc.m')
matlabFunction(simplify(veq_opt,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','v_b_dklc.m')
