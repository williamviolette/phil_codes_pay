function    [h,util,sim,nA,nB,A,B] = obj(given,nA,sigA,Alb,Aub,nB,sigB,Blb,nD,s,int_size,refinement)
...
probe = [(1-prob_move).*ones(n_states,n_states/2) (prob_move).*ones(n_states,n_states/2)]./(n_states./2);
[chaine,~] = markov(probe,4,s0);

chain(end) = chaine(end);
