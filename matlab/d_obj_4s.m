function    [h,util] = d_obj_4s(given,prob,A,Aprime,nA,B,Bprime,nB,chain)
...
[util1,util2,util3,util4] = ...
         gen_d_4s(A,B,Aprime,Bprime,r_high,r_lend,r_water,water_lending,Y_high,Y_low,lambda_high,lambda_low,p1,p2,alpha);
...
for i = 1:n-1
    ...
    [~,~,~,~,w1,w2,w3,w4] = ...
         gen_d_4s(Athis,Bthis,Ap,Bp,r_high,r_lend,r_water,water_lending,Y_high,Y_low,lambda_high,lambda_low,p1,p2,alpha);
