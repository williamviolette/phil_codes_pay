function    [h,util,sim] = dc_obj_chow(given,prob,nA,sigA,nB,sigB,nD,chain,s)
...
[v,decis]=opt_loop(v,util1,util2,util3,util4,beta,prob,nA,nB,nD,metric);
...
for f =1:2
    ...
    [A,Aprime,B,Bprime,D,Dprime,nA,nB] = grid_int(nA,sigA,nB,sigB,nD, int_size);
    [util1,util2,util3,util4] = ...
         gen_dc_4se(A,B,D,Aprime,Bprime,Dprime,r_high,r_lend,r_water,water_lending,Y_high,Y_low,p1,p2,p1d,p2d,pd,alpha,k_high,k_low,lambda_high,lambda_low);
    [v,decis]=opt_loop(v,util1,util2,util3,util4,beta,prob,nA,nB,nD,metric);
