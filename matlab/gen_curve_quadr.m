function [w1,w2,w3,w4,util1,util2,util3,util4] = ...
         gen_curve_quadr(A,B,D,Aprime,Bprime,Dprime,r_high,r_lend,r_water,h,vh,Y_high,Y_low,p1,p2,pd,alpha,curve,untied,fee)
...
if untied==0
    ...
    if fee>0
        ...
        if nargout>4
                    debt_12 = 1;
                    [w1,util1] = u_quadr(Lf_12,debt_12,alpha,p1,p2, Y_high + y_12f, 1);
                    [w2,util2] = u_quadr(Lf_12,debt_12,alpha,p1,p2, Y_low  + y_12f, 1);

                    debt_34 = 0;
                    [w3,util3] = u_quadr(0,debt_34,alpha,p1,p2,Y_high + y_34f, 1);
                    [w4,util4] = u_quadr(0,debt_34,alpha,p1,p2,Y_low  + y_34f, 1);
                else
                        debt_12 = 1;
                        [w1] = u_quadr(Lf_12,debt_12,alpha,p1,p2, Y_high + y_12f, 1);
                        [w2] = u_quadr(Lf_12,debt_12,alpha,p1,p2, Y_low  + y_12f, 1);

                        debt_34 = 0;
                        [w3] = u_quadr(0,debt_34,alpha,p1,p2,Y_high + y_34f, 1);
                        [w4] = u_quadr(0,debt_34,alpha,p1,p2,Y_low  + y_34f, 1);
        end
else
    ...
    if fee>0
        ...
        if nargout>4
                    debt_12 = 0;
                    [w1,util1] = u_quadr(0,debt_12,alpha,p1,p2, Y_high + y_12f, 1);
                    [w2,util2] = u_quadr(0,debt_12,alpha,p1,p2, Y_low  + y_12f, 1);
                    util3=util1;
                    w3=w1;
                    util4=util2;
                    w4=w2; 
                        ...
                        debt_12 = 0;
                        [w1] = u_quadr(0,debt_12,alpha,p1,p2, Y_high + y_12f, 1);
                        [w2] = u_quadr(0,debt_12,alpha,p1,p2, Y_low  + y_12f, 1);
                        w3=w1;
                        w4=w2;
        end
end
