...
temp ='/Users/williamviolette/Documents/Philippines/phil_analysis/phil_temp_pay/';
...
%beta   = inv(1+0.1);              % subjective discount factor 


p_caught = .0084;

prob   = [ 0, (1-p_caught), p_caught  ; ...
           0, (1-p_caught), p_caught  ; ...
           1,  0,  0 ];
...
[util1h,util2h,util3h,w1h,w2h,w3h] = ...
    u_w2loans(A,Aprime,alpha,p,r_high,r_low,r_lend,Y_high,lambda_high);

[util1l,util2l,util3l,w1l,w2l,w3l] = ...
    u_w2loans(A,Aprime,alpha,p,r_high,r_low,r_lend,Y_low,lambda_low);
...
for i = 1:n-1
    ...
    [~,~,~,w1h,w2h,w3h] = ...
    u_w2loans(Athis,Aprime,alpha,p,r_high,r_low,r_lend,Y_high,lambda_high);

    [~,~,~,w1l,w2l,w3l] = ...
    u_w2loans(Athis,Aprime,alpha,p,r_high,r_low,r_lend,Y_low,lambda_low);
...
%sum(states(:,2)==5 | states(:,2)==6 )/size(states(:,2),1)
