...
given   =   [ 0     .04        .4    alpha     .01    y_avg   p_avg  n  10  3 r_lend ];
...
ag = given(1,option);  
obj = @(a1)m_1loan3_lend2_objopt(a1,given,data,option,option_moments,weights,prob,A,Aprime,Agrid,inA,minA,nA,chain);
...
given1   =   [ 0     .04        .45    .018     .01    y_avg   p_avg  n  10  4  r_lend ];
...
for s = 1:size(S,2)
    given1(2) = S(s);
    h = m_1loan3_lend2_obj(given1,prob,A,Aprime,Agrid,inA,minA,nA,chain);
    H(:,s)=h;
end
