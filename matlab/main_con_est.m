...
given   =   [ r_lend     .04        .4    .024    .02    y_avg p1 p2 n   10  3 ];
...
h = con_obj(given,prob,A,Aprime,Agrid,inA,minA,nA,chain);
...
% given :  r_lend , r_high, lambda , alpha ,  beta_up , Y , p1, p2 ,  n , metric,m
given1   =   [ r_lend   .04   .6    .022     .02    y_avg    p1  p2  n  10  5  ];
...
for s = 1:size(S,2)
    given1(2) = S(s);
    [h,US] = con_obj(given1,prob,A,Aprime,Agrid,inA,minA,nA,chain);
    H(:,s)=h;
    U(1,s)=US;
end
