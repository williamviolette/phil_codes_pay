...
matlabFunction(wse,'File','w_reg_ql.m')
matlabFunction(vse,'File','v_reg_ql.m')
...
veq_opt = simplify( xeq_opt - (1/(2*alpha))*(weq_opt - k )^2  );
...
matlabFunction(simplify(weq_opt,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','w_b_ql.m')
matlabFunction(simplify(veq_opt,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','v_b_ql.m')
