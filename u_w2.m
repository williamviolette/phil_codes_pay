function [util1,util2,util3,w1,w2,w3] = ...
    u_w2(A,Aprime,alpha,p,r_high,r_low,Y)
...
w1 = w_reg(A,Aprime,alpha,p,r_high,Y).*I1_s1 + ...
     w_reg(A,Aprime,alpha,p,r_low,Y).*I1_s2 + ...
     w_b(A,Aprime,alpha,p,r_high,r_low,Y).*I1_s3 ;

util1 = v_reg(A,Aprime,alpha,p,r_high,Y).*I1_s1 + ...
...
w2 = w_reg(A,Aprime,alpha,p,r_high,Y).*I2_s1 + ... %%% saving
...
util2 =  v_reg(A,Aprime,alpha,p,r_high,Y).*I2_s1 + ... %%% saving
...
w3 = w_reg(A,Aprime,alpha,p,r_high,Y).*I3_s1 + ...
     w_reg(A,Aprime,alpha,p,r_high,Y).*I3_s2  ;

util3 = v_reg(A,Aprime,alpha,p,r_high,Y).*I3_s1 + ...
