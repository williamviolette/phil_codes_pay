...
Utility disconnections for nonpayment are common across both developing and developed countries.  In the United States, \cite{cicala2021incidence} finds that disconnection rates are four times higher in minority communities, and many states restrict disconnections during extreme weather to protect public health (\cite{liheap}).  Cross-country practices vary widely: water shutoffs are forbidden in the United Kingdom, Australia, and France but permitted as a debt recovery tool in most other countries (\cite{marques2023water}).  In developing countries, high nonpayment rates have motivated the widespread adoption of prepaid meters---now used in more than 20 African countries (\cite{heymans2014limits})---while \cite{burgess2020consequences} describe a ``vicious circle'' in which tolerated nonpayment undermines utility finances and erodes payment incentives.

Policies on interest and penalties for utility arrears also vary considerably.  In many countries, water is treated as a basic human right (\cite{unga2010water}), and utilities are prohibited from charging interest on late payments.  In the Philippines, the water utility in Manila charges no interest on outstanding bills, though other Philippine providers impose late surcharges of around 10\% (\cite{mnwd_guidelines_bills_payments}; \cite{ppcwater_ur_billing}).  The absence of interest charges effectively makes delayed payments an interest-free loan from the utility to the household---an implicit lending role that is rarely recognized in utility regulation (\cite{laffont2005regulation}).

Manila offers a distinctive setting that combines developing-country income levels and credit constraints with relatively strong administrative capacity and credible enforcement.  Following the 1997 concession reform, Metro Manila's water system was split between two large private concessionaires operating under identical regulatory conditions (\cite{wu2008tale}), providing a natural framework for revenue-neutral policy comparisons.  Universal metering, standardized billing cycles, and systematic tracking of arrears and disconnections produce detailed administrative records that allow for observing consumption, payments, and disconnections at high frequency.  Unpaid bills trigger a formalized sequence of delinquency notices and potential disconnection, creating a credible intertemporal tradeoff between current liquidity and the risk of future service interruption.  At the same time, households face very limited access to formal credit (\cite{demirguc2018global}), with the most common lending sources---moneylenders and microfinance groups---charging average monthly interest rates around 9.5\%, while the utility charges no interest on arrears.  This sharp contrast makes the credit value of delayed payments especially large.  The core mechanisms---liquidity smoothing through arrears, dynamic responses to disconnection risk, and interactions between nonlinear tariffs and payment timing---are common features of urban utility provision across the developing world.  Increasing block tariffs are standard in urban water systems throughout Latin America, South Asia, and Sub-Saharan Africa (\cite{komives2006distributional}; \cite{hoque2013state}), and utilities in these settings often function as de facto credit providers by tolerating delayed payments before disconnection (\cite{burgess2020consequences}; \cite{mcrae2015infrastructure}).  These mechanisms are therefore likely to arise wherever credit-constrained households face utilities with staged enforcement, though the quantitative magnitudes will depend on local credit conditions.  The results may be less applicable where billing capacity is weak and enforcement is unpredictable, where prepaid metering is universal (\cite{jack2020charging}), or where utilities impose immediate disconnection for nonpayment.
