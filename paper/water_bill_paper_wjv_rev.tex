...
Manila offers a useful setting for studying how billing policy affects household welfare.  Households face very limited access to formal credit, with the most common lending sources---moneylenders and microfinance groups---charging average monthly interest rates around 9.5\%.  The sharp contrast between high market borrowing rates and zero interest on utility arrears makes the credit value of delayed payments especially large.  The water utility tolerates substantial delinquency before disconnecting households, and detailed administrative billing records allow for observing consumption, payments, and disconnections at high frequency.  Manila's water sector was privatized in 1997, splitting Metro Manila between two concessionaires under identical regulatory conditions (\cite{wu2008tale}), providing a natural framework for revenue-neutral policy comparisons.  The core mechanism---households timing bill payments to smooth consumption---is likely to arise wherever credit-constrained households face utilities that tolerate delinquency (\cite{burgess2020consequences}), though the quantitative magnitudes will depend on local credit conditions and enforcement practices.
