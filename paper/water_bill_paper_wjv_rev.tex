...
Manila offers a useful opportunity to study utility billing policy in a lower-middle income country.  Unlike in many other developing cities, large infracture investments resulted in universal metering, standardized billing cycles, and systematic tracking of arrears and disconnections.  These features allow for precisely observing consumer behavior at high frequency (\cite{wu2008tale}).  Stable water supply and relatively high water quality ensure that usage patterns reflect consumer demand fluctuations.  While lessons from Manila may not be immediately applicable to many developing cities with low levels of service quality, metering coverage, and enforcement capacity (\cite{kingdom2006challenge}), they may inform future policy as countries make large infrastructure investments (\cite{WEF2025WaterGap}).
...
%  How common are shutoffs elsewhere? 
%  Are utilities typically allowed to charge interest on arrears? 
%  What is distinctive about Manila and what may generalize?

% Utility disconnections and penalties for nonpayment are common across both developing and developed countries.  In the United States, \cite{cicala2021incidence} finds that disconnection rates are four times higher in minority communities, and many states restrict disconnections during extreme weather to protect public health (\cite{liheap}).  Water shutoffs are often permitted as a debt recovery tool in most high and middle income countries reviewed by \cite{marques2023water}.  


% Likewise, unpaid balances accrue interest in South Africa (\cite{szabo2015reducing}) and some Phillipine providers outside of Manila charge late fees (\cite{mnwd_guidelines_bills_payments}; \cite{ppcwater_ur_billing}).  

% In developing countries, high nonpayment rates have motivated the widespread adoption of prepaid meters (\cite{heymans2014limits}).
% In some countries, water is treated as a basic human right (\cite{unga2010water}), prohibiting utilities from charging interest on late payments. In India, \cite{burgess2020consequences} describe a ``vicious circle'' in which tolerated nonpayment undermines utility finances and erodes payment incentives. 


% In developing countries, policies on interest and penalties for utility arrears vary considerably. 

% By contrast, study a context where .  Water utilities in Manila charge no interest on outstanding bills, though other Philippine providers impose late surcharges on outstanding bills 


% The absence of interest charges effectively makes delayed payments an interest-free loan from the utility to the household---an implicit lending role that is rarely recognized in utility regulation (\cite{laffont2005regulation}).

% At the same time, households face limited access to formal credit (\cite{demirguc2018global}), with the most common lending sources---moneylenders and microfinance groups---charging average monthly interest rates around 9.5\%, while the utility charges no interest on arrears.  This sharp contrast makes the credit value of delayed payments especially large.  
