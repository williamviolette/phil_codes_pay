...
The counterfactual further calculates that households would be indifferent to having prepaid meters if the borrowing cost of the standard asset were also lowered from from 9.5\% (see Table~\ref{table:calibratedparam}) to 7\%.  This result suggests that pairing prepaid meters with microloan programs or other credit policies could help offset the consumer welfare effects of prepaid meters.
