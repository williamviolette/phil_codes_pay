...
The last counterfactuals consider using penalty fees to reducing billing delinquency. For example, other water providers in the Philippines impose late penalties of around 10\% of total unpaid balances.\footnote{See \cite{mnwd_guidelines_bills_payments} and \cite{ppcwater_ur_billing}.}
