...
This paper incorporates delayed bill payments into household consumption and savings decisions in order to evaluate the welfare effects of counterfactual payment policies such as prepaid metering.  This paper studies a large piped water utility in Manila, Philippines where detailed administrative data record household consumption, bill payments, and disconnections for nonpayment.  Manila's regulation of nonpayment and disconnection is similar to most other middle and high-income countries (\cite{marques2023water}).  In Manila, unpaid water bills average 5.5\% of household income, exceeding most other sources of short-term credit.\footnote{On average, short-term loans, which are mainly from moneylenders and microcredit agencies, only equal about 2.5\% of household income according to the 2014 Consumer Finance Survey.}  Descriptive evidence suggests that households time their bill payments to smooth their consumption when they face sudden income changes.  Out of each 100 PhP increase in income, households spend around 1 PhP on their unpaid water bills without changing their water consumption.\footnote{``PhP'' refers to Philippine Pesos where 45 PhP = 1 USD.}

Manila provides a lower-middle income setting with universal metering, standardized billing cycles, and systematic enforcement of arrears and disconnections (\cite{wu2008tale}).  These features allow for measuring consumer behavior at high frequency.  Stable water supply and relatively high water quality over the study period ensure that usage patterns reflect consumer demand fluctuations.  Although many developing cities may operate under lower service quality levels and weaker enforcement capacity (\cite{kingdom2006challenge}), the Manila context is likely informative for countries undergoing similar infrastructure expansions (\cite{WEF2025WaterGap}).

% In 1997, Manila’s water system transitioned from public provision to regulated private operators (\cite{wu2008tale}).  These operators have invested heavily in universal metering, standardized billing cycles, and systematic tracking of arrears and disconnections.  This setting produces detailed administrative records that allow for observing consumption, payments, and disconnections at high frequency.  
% - Dense , rich/poor next to eachother -> not too costly to enforce
% - Not water constrained -> very few shortages, water is generally good quality
% - high financial inclusion?
% In many other lower-middle-income countries, utilities operate with weaker infrastructure, higher rates of non-revenue water, lower metering coverage, and less systematic enforcement of arrears (\cite{kingdom2006challenge}).  However, continued investments in service modernization suggest that lessons from Manila may soon apply to many other developing cities (\cite{WEF2025WaterGap}). 
% because it provides relatively high-capacity service provision.
...
% Each month, households consume 24m3 of piped water on average, which totals an average monthly bill of 668PhP as shown in Table~\ref{table:descriptives_all}.  Given an average monthly income in Manila of 21,907PhP and savings rate of 5,730PhP,  monthly water bills reach a modest average of 3.0\unskip\% of income and 11.7\unskip\% of savings.  
...
Households often delay their water bills.  Instead of paying each month, households make large, infrequent payments.  Table~\ref{table:descriptives_all} provides summary statistics on household consumption, billing, and payments.  While the average bill is 668 PhP per month, payments average 897 PhP, occur in 71\unskip\% of months, and leave households 58 days behind on their bills.  Each month, the average household maintains 1,235 PhP in unpaid water bills and 3,077 PhP in small-scale loans mainly from money lenders and micro-finance groups.\footnote{According to the 2014 Consumer Finance Survey in Manila, 12\% of households have small-scale loans.  Average loan sizes equal 51,280 PhP with an average period of 9 months.  In any given month, households with loans owe 25,640PhP, which translates to an average outstanding balance of 3,077PhP across all households.}   With average monthly incomes of 21,907 PhP, households spend around 3\% of their income on water while unpaid water bills total around 5.5\% of their income.\footnote{For reference, 1 USD is worth around 45 PhP over this period.}   
...
\midrule
Consumption (m3) & 24 & 21 &  15 \\
Bill &  668 & 446 &  730 \\
Unpaid Balance &  1,235 & 331 &  3,412 \\
Payment &  897 & 595 &  1,058 \\
Payment Frequency &  0.704 & 1.000 &  0.457 \\
Disconnection Frequency &  0.015 & 0.000 &  0.122 \\
Income &  21,907 & 16,000 &  19,841 \\
...
% The borrowing rate from standard assets is estimated to be 2.2\unskip\% per month, which implies an annual interest rate of 29.8\unskip\%.  This estimate is substantially lower than the 20\% per month interest rate that \cite{karlan2009expanding} document as being commonly charged by moneylenders in Manila.  Despite this high interest rate, \cite{karlan2009expanding} document that at least 30\% of their sample of microentrepreneurs report taking credit from moneylenders.  The estimated borrowing rate of 2.2\unskip\% is more similar to microloans of 1,000 PhP at 2.5\% monthly interest offered to rural Filipino households as part of a microfinance experiment conducted by \cite{gine2014group}.\footnote{The annual interest rate of 29.8\unskip\% well exceeds the average 13 to 25\% range offered by microfinance providers worldwide surveyed by \cite{cull2009microfinance}.  Two possible reasons for this discrepancy are that (1) institutional reasons unique to Manila may limit lenders' abilities to offer low rates and (2) subsidies may allow many microfinance providers to offer below-market interest rates.}
...
Water Preference  ($\alpha$) & 54.0 \\
 &   (0.08\unskip) \\[.4em]
Fixed Cost of Alternative Water ($f$) &  325.0 \\
 &    (24.7\unskip) \\[.4em]
Rate of Delinquency Warnings ($\lambda$) &  0.220 \\
 &   (0.002\unskip) \\[.8em]
Households &  33,166 \\
Household-Months &  2,021,144 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item 
...
Bill &  668 & 597  \\
Unpaid Balance &  \cellcolor{black!15}1,235  &  \cellcolor{black!15}1231  \\
Payment &  897 &  676 \\
Payment Frequency &  0.704 &  0.883  \\
Disconnection Frequency &  \cellcolor{black!15}0.015  &  \cellcolor{black!15}0.015 \\
Disconnection Length (Months) & 6.7 & 2.7  \\
Unpaid Balance Upon &  7923 &  7620  \\[-.5em]
...
\begin{enumerate}
	\item \textit{Lending Costs}:  By tolerating unpaid bills, the utility extends credit to households each month at zero interest rate.  The opportunity cost of this credit is equal to the 0.47\% monthly interest rate that the utility pays on its own loans to fund its pipe infrastructure.\footnote{The 0.47\% monthly interest rate is equal to a 5.75\% annual interest rate.}  These opportunity costs average 6 PhP per household-month.  The utility also loses revenue from households that leave unpaid bills when they disconnect, which average 20 PhP per household-month.  Total lending opportunity costs per household can be expressed as $ - \chi B_T + \sum_{t=1}^{T}  - 0.0047 B_t $ where $B_t$ ($<0$) equals unpaid bills each month and $\chi$ is the share of households that leave unpaid bills upon disconnection.

	\item \textit{Warning Costs}:  The utility incurs costs visiting and warning each delinquent household about their unpaid bills.  The cost of administering each warning is assumed to equal the reconnection fee of 200 PhP, which leads to average warning costs of 29 PhP per household-month.\footnote{Conversations with the utility suggest that travel costs make up the majority of the costs for any service performed on a water meter.}  Total warning costs per household can be expressed as  $\sum_{t=1}^{T} 200 \lambda \mathbbm{1}\{B_t < 0 \}  $ where $ \mathbbm{1}\{B_t < 0 \}$ indicates months where households are delinquent and $\lambda$ indicates the share of months where the utility conducts warnings.
...
\end{align}
where $FC$ equals fixed costs in monthly terms and averages 421 PhP per household-month.  Fixed costs are assumed to remain constant in counterfactual simulations.  As each counterfactual policy changes household consumption and billing patterns, the simulation adjusts the marginal price per cubic meter, $p_1$, to satisfy equation (\ref{utilitybc}).  For each counterfactual policy, Table~\ref{table:countercosts} provides simulated cost and price changes, and Table~\ref{table:counter} provides simulated household outcomes.  
...
\midrule
% Rate of Delinquency Warnings & 0.22& 0.00  & 0.11  \\
Lending Costs  & 26  & 0  & 44  & 19  & 16  \\
  % & 6  & 0  & 15  \\
% Unpaid Balance Upon Disconnection 		 &  20 & 0   &  29 \\
Warning Costs & 29 & 0    &   18  & 1  & 7  \\
Pumping Costs  &  121  & 124    &   128  & 124  & 124  \\
Fixed Cost &  421  &  421     &   421  &  421  &  421  \\
Price per m3  &  17.6 & 14.8    &  16.3  & 15.4  & 15.4  \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item
...
Despite the decrease in prices, the exercise predicts that prepaid metering lowers social welfare.  The first row of Table~\ref{table:counter} calculates the compensating variation associated with each policy, which measures the change in monthly household income needed to make households indifferent between the current scenario in Manila and each policy.  Column (2) predicts that households would require an increase in their monthly incomes of at least 40 PhP in order to be willing to switch to prepaid metering.   This decline in welfare appears entirely driven by removing households' ability to smooth consumption through unpaid bills.  Comparing columns (1) and (2), unpaid balances drop from 1,235 to 0 PhP and standard borrowing levels drop by around 80 PhP.  These findings suggest that households substantially reduce their overall borrowing levels when credit from unpaid bills is no longer available.  

The counterfactual further calculates that households would be indifferent to having prepaid meters if the monthly interest rate of the standard asset were also lowered from from 9.5\% to 7\%.\footnote{See Table~\ref{table:calibratedparam} for list of calibrated parameters.}  This result suggests that pairing prepaid meters with microloan programs or other credit policies could help offset the consumer welfare effects of prepaid meters.
...
\toprule
 ...
 & Current & Prepaid Metering & 50\% Less Enforcement  & Late Penalty & 4.9\% Interest  \\
\midrule
Compensating Variation &   & 40  & -117  & 4  & 5  \\
Consumption (m3)	 &   24.2 & 24.8    &  25.7  & 24.8    &  24.7 \\
Bill			 &   597 & 546    &  613  & 563    &  558 \\
Unpaid Balance & 1235 & 0    &  3199  & 128    &  187  \\
Standard Borrowing & 765 & 688    &  710  & 681    &  712  \\
% Standard Asset & 19965 & 20240    &  19767  \\
% Standard Borrowing & -7970 & -8097    &  -7759  \\
% Standard Saving & 22929 & 22872    &  22542  \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item
...
\subsection{Late Penalty and Interest Rates on Unpaid Bills}\label{section:latepenalty}

The last counterfactuals consider alternative approaches to reducing billing delinquency to capture the fact that other water providers in the Philippines impose late penalties of around 10\% of total unpaid balances.\footnote{See \cite{mnwd_guidelines_bills_payments} and \cite{ppcwater_ur_billing} for examples.}

Column (4) of Tables~\ref{table:countercosts} and Table~\ref{table:counter} considers a fixed late penalty calibrated to 10\% of the average unpaid balance.\footnote{This policy imposes an additional fee of $10\% \times 1{,}235 = 123.5$ PhP each month that a household carries a negative water balance ($B_{t+1}<0$) and remains connected.} Column (5) of Tables~\ref{table:countercosts} and Table~\ref{table:counter} imposes a fixed monthly interest rate of 4.9\% on unpaid water bills that accumulate while the household is connected.  This percentage is calibrated to reflect the fact that  households are on average two months in arrears, so the 10\% penalty would often be spread over two months.

These policies have similar effects.  Both leave households roughly indifferent to the current equilibrium.  Households borrow much less from their unpaid balances.  Cost savings from lower unpaid balances are passed onto households in the form of slightly lower water prices.  

Despite having relatively low unpaid balances, households are still considerably better off than under prepaid metering.  This finding is consistent with households deriving substantial value from having access to unpaid bills as an emergency credit option.
...
% This paper builds a dynamic model of household consumption smoothing to measure the extent to which households value billing flexibility.  Estimates imply that households' valuation of flexibility is on the order of 7\unskip\% of their monthly water bills.  Counterfactual exercises further find that policies to eliminate nonpayment --- raising interest rates on unpaid bills and prepaid metering --- do not produce enough cost savings to justify their negative impacts on household consumption smoothing.\todo[color=red]{i'm still not sure i get this... what are the cost savings?}  On net, these policies are predicted to reduce social welfare by between 1.1and 5.0USD per household-month.  \todo[color=red]{i would add more oomph to this. i think this is really interesting but the punchline needs to be bigger!}
...
The dataset for the main analysis focuses on months including and after March, 2010 because these months do not include gaps in payment and billing records (except that all data are missing for June, 2014).  Excluding data before March, 2010 brings the final sample size to 2,021,144 household-months.
...
\midrule
Initial sample   &         4,678,420  &     \\
Keep residential connections (excluding commercial)   &            &    632,903  \\
Keep connections with payment records &  &   40,708   \\
Keep months with usage under 200 m3    &            &  73,219     \\
Keep bills $>$ -5,000 PhP and $<$ 80,000 PhP  &  & 84,048  \\
Keep unpaid bills $>$ -5,000 PhP and $<$ 80,000 PhP &             &     12,087  \\
Keep payments $>$ -80,000 PhP and $<$ 80,000 PhP    &            &    791   \\
% Keep connections with over 30 months of records   &            &   0    \\
Keep connections serving a single household   &            &   961,849    \\
...
Mean Income (PhP) & $\bar{y}$ & 21,907 & {\footnotesize Pasay City Household Panel Survey} \\
...
Tariff    & $(p_1 + p_2 w)$ & $(17.6 + 0.3w)$ & {\footnotesize Estimated price by water usage  (See Appendix~\ref{appendix:tariff} for details) } \\
...
\midrule   
Assumed Preferences\\
\hspace{1em}Discount Rate ($\delta$)  & .005  & .024 & .0025  & .005 & .005     \\
\hspace{1em}CRRA Curvature ($\gamma$)  & 1  & 1 & 1 & 2 & .5     \\[.5em]
Estimates \\
\hspace{1em}Water Preference  & 54.0 & 48.0 & 54.0 & 53.6 & 54.5 \\
\hspace{1em}Fixed Cost of Alternative  &  325.0  &  433.5  &  332.5  &  382.5  &  283.0  \\
\hspace{1em}Rate of Warnings  &  0.220 &  0.245 &  0.21 &  0.21 &  0.24 \\[.5em]
Compensating Variation \\
\hspace{1em}Prepaid Metering &  40 &  72 &  54 &  113 &  5   \\
\hspace{1em}50\% Less Enforcement & -117 & -188 & -112 & -161 & -94    \\
\hspace{1em}Late Penalty & 4 & 9 & 1 & 31 & -31    \\
\hspace{1em}4.9\% Interest Rate & 5 & 15 & 6 & 50 & -32    \\
% &   (0.002\unskip) \\[.8em] % Households &  33,166 \\ % Household-Months &  2,021,144 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item 
\footnotesize
This table re-estimates the model under four alternate assumptions on preferences.  Column (1) repeats earlier estimates, columns (2) and (3) consider high and low discount rates respectively, and columns (4) and (5) consider high and low levels of risk aversion respectively.  The high discount rate of 0.024\% is chosen to match the implied monthly discount rate according to the experimental meta-analysis, \cite{matousek2022individual}.  This rate is also similar to high discount rates implied by experimental results in the Philippines by \cite{ashraf2006tying}.  All measures are per average household-month. Compensating variation measures the change in monthly income in PhP needed to make households indifferent between the current scenario and each of the two counterfactual scenarios.
\end{tablenotes}
\end{threeparttable}
%}
\end{table}
...
\toprule
 ...
 & Current & Prepaid Metering & 50\% Less Enforcement  & Late Penalty & 4.9\% Interest  \\
\midrule
Compensating Variation &   & 39  & -92  & 9  & 3  \\
Consumption (m3)	 &   37.5 & 37.8    &  38.5  & 37.8    &  37.7 \\
Bill			 &   660 & 612    &  673  & 621    &  621 \\
Unpaid Balance & 1260 & 0    &  3135  & 88    &  179  \\
Standard Borrowing & 735 & 688    &  683  & 684    &  709  \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item
