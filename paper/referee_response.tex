...
\item \refquote{Provide more institutional context and discussion of external validity (e.g., How common are shutoffs elsewhere? Are utilities typically allowed to charge interest on arrears? What is distinctive about Manila and what may generalize?).}
  \begin{refpoints}
  \item Rather than a standalone background section, the revised paper embeds institutional context and external validity discussion directly into the relevant sections.  A new paragraph in the Introduction \parref{par:manilacontext} describes what is distinctive about Manila---universal metering, standardized billing cycles, systematic enforcement, and high water quality---and discusses where the context is likely to generalize and where it may not.  A new paragraph in Section~\ref{paper-section:descriptives} \parref{par:crosscountry} provides cross-country evidence on disconnection prevalence and penalty policies for utility arrears, covering South Africa, the United States, and other countries.  Together these additions address (1) the prevalence of utility disconnections across developing and developed countries, (2) the variation in policies on interest and penalties for utility arrears, (3) what is distinctive about Manila, and (4) the limits of external validity.
  \end{refpoints}
