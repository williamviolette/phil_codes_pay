...
\item \refquote{Given the research question, in my opinion, the paper would be a better fit for a development economics journal.}
  \begin{refpoints}
  \item Thank you for raising this.  The revised Introduction now includes a new sentence (p.~\pageref{paper-par:iocite}, \parref{par:iocite}) that connects the paper to an IO literature on regulating non-price dimensions of service provision (Spence, 1975; Laffont and Tirole, 1993).
  \end{refpoints}
\end{refpoints}
