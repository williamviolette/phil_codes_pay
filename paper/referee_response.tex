...
\item \refquote{The paper studies a strange pattern of behavior: a large share of the population regularly allows its water to be turned off. To better understand what is going on, it would be helpful to have some background information for comparison with other countries. In other countries, how common is it for utilities to be turned off? How common is it for utility companies to be prohibited from charging interest on late payments?}
  \begin{refpoints}
  \item Thank you for this suggestion.  The revised paper now includes a new Section~\ref{paper-section:background} (``Background'') that addresses these questions with cross-country evidence.  In brief: disconnections for nonpayment are common in both developing and developed countries---Cicala (2021) documents that US disconnection rates are four times higher in minority communities, while Marques et al.\ (2023) find that water shutoffs are explicitly forbidden in the UK, Australia, and France but permitted as a debt recovery tool in most other countries.  Regarding interest on arrears: practices vary widely, with many countries prohibiting interest on water bills, though some Philippine water providers impose late penalty surcharges of around 10\%---which motivates the late penalty counterfactual in our revised analysis.  What is distinctive about Manila is the combination of (1) very limited formal credit access with high borrowing rates (around 9.5\% monthly), (2) zero interest on arrears, and (3) detailed administrative billing data.  Burgess et al.\ (2020) describe a general ``vicious circle'' of tolerated nonpayment that suggests the core mechanism is likely to arise in many settings, though the magnitudes will depend on local credit conditions and enforcement practices.
  \end{refpoints}
