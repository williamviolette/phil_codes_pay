...
\newcounter{parnum}
\newcommand{\parmark}{\refstepcounter{parnum}\textsuperscript{\textcolor{blue}{[\theparnum]}}\marginpar{\footnotesize\textcolor{blue}{\P\theparnum}}}
...
\toprule
 & (1)    & (2)          & (3)  & \added{(4)}\parmark\label{par:costtable}  & \added{(5)}  \\
...
\begin{tabular}{@{}l*{1}{EEEEE}@{}}
\toprule
 & (1)    & (2)          & (3)  & \added{(4)}\parmark\label{par:outcometable}  & \added{(5)}  \\
 & Current & Prepaid Metering & 50\% Less Enforcement  & \added{Late Penalty} & \added{4.9\% Interest}  \\
\midrule
...
\parmark\label{par:latepenaltysection}\added{\subsection{Late Penalty and Interest Rates on Unpaid Bills}\label{section:latepenalty}}
...
\added{These policies have similar effects.  Both leave households roughly indifferent to the current equilibrium.  Households consume borrow much less from their unpaid balances.  Cost savings from lower unpaid balances are passed onto households in the form of slightly lower water prices.}
...
\parmark\label{par:linearpricesappendix}\added{\subsection{Single Marginal Price}\label{appendix:linearprices}}
