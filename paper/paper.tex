...
\maketitle
\begin{abstract}
% At the same time, delaying bill payments contributes to utilities' costs, which are often passed on to households through prices.  
...
% Alternatively, households would be willing to pay a premium equal to 18\% of their water expenditure to enact a revenue-neutral policy that allows more late payments and increases consumption smoothing.

% encourages delaying bill payments by 
...
% The second policy halves
% This paper measures this trade-off using administrative data from a large water utility in Manila, Philippines.  
...
% \todo[color=red]{A so there's 2 things going on here, right? 
% 1. i get credit by not paying my bill on my fixed consumption c
% 2. more credit by not paying and consuming c'>c cause it's cheaper than buying other beverages } 
% \todo[color=red]{A  i'm still having trouble here. is this just the option of not paying? but what's the risk? what are the terms of this "loan"? how long can i do it? etc. 
...
% oh ok. borrowing costs from i guess formal lenders and also roscas and all those informal ones}
